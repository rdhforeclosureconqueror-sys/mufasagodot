...
func _process(_delta: float) -> void:
	...
	if lobby_client != null and lobby_client.has_method("diagnostic_snapshot"):
		var multiplayer_value = lobby_client.call("diagnostic_snapshot")
		if multiplayer_value is Dictionary:
			multiplayer = multiplayer_value
